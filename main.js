...
function addContact(event) {
  ...
  let phone = event.target.contactPhone.value;
  let emcont = event.target.emergencycontact.checked;
  let currentContact = {
    Id: generateId(),
    Name: contact, 
    Phone: phone,
    EmergencyContact: emcont
  };
...
function drawContacts() {
 ...
 contacts.forEach(contact => {
   template += `
    <div class="card ${contact.EmergencyContact ? 'emergency-contact' : ''} mt-1 mb-1">
